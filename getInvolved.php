...
<div class="container">
    ...
    <fieldset class="form-group border p-3">
        <legend class="font-weight-bold text-center" id="services">Make a Donation</legend>
    ...
    <!--##################    VOLUNTEER SECTION   ##################-->
    <fieldset class="form-group border p-3">
        <legend class="font-weight-bold text-center" id="services">Volunteer</legend>
    ...
    <fieldset class="form-group border p-3">
        <legend class="font-weight-bold text-center" id="services">Seasonal Opportunities</legend>
    ...
    <!--##################    DONATIONS SECTION   ##################-->
    <fieldset class="form-group border p-3">
        <legend class="font-weight-bold text-center" id="services">General Donations</legend>
